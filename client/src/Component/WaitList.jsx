...
function WaitListPage() {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-col-reverse items-center justify-between gap-[120px] lg:gap-[124px] px-4 md:px-8 lg:px-0">
        {/* Image Grid */}
        ...
        <div className="w-full lg:flex-1 flex flex-col gap-6 md:gap-[48px] text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 items-center justify-center lg:justify-start">
                <div className="flex w-full items-center justify-center">
                    <form onSubmit={handleWaitList} className='w-[60%] max-phone:w-[80%] flex flex-col gap-5'>
